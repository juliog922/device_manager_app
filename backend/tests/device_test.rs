...
use backend::models::device::{Auth, Device};
...
fn test_basic_device() {
    ...
    let device = Device::from_value(&json_value).expect("Device cannot be created");
...
fn test_oauth2_device() {
    ...
    let json_data = r#"
    {
        ...
        "auth": {
            ...
            "auth_url": "/rest-gateway/rest/api/v1/auth/token"
        }
    }
    "#;
